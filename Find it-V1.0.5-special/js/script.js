...
const listOfSprites = ["models/sprites/Userious.png", "models/sprites/noWay.png", "models/sprites/lmao.png", "models/sprites/hm.png", "models/sprites/shitting.png"]
...
submit.onclick = function(){ 
  ...
  if (username !== '' && username !== undefined && username !== null){
    ...
    startButton.addEventListener("click", function (){
      ...
      generateIMGs(10, otherIMG1)
      generateIMGs(10, otherIMG2)
      startTimer()
...
function selectIMGSources(){
  ...
  IMGDisplay.style.backgroundImage = "url(" + listOfSprites[firstIMGIndex] + ")"
...
function generateIMGs(nmb, img) {
  img.onload = () => {
    for (let i = 0; i < nmb; i++) {
      let x;
      let y;
      do {x = randint(30, 470, 100); y = randint(30, 470, 100)} while (xAndyExists(imagesCoords, x, y));
